    ...
    return (
        <Stack spacing={3} padding="20px" width="50%" boxShadow="xl">
            <form onSubmit={handleSubmit}>
                ...
                <br />
                <Button colorScheme={isEmailError || isUsernameError || isPasswordError || isConfirmPasswordError ? "grey" : "teal"} type="submit" disabled={isEmailError || isUsernameError || isPasswordError || isConfirmPasswordError}>
                    Sign Up
                </Button>
            </form>
        </Stack>
